...
export const metadata = {
  ...
  description: "Профессиональные замеры помещений для точных проектов: измерение габаритов, углов, определение расположения розеток и влажных зон. Гарантия точности и удобства дальнейших работ.",
};
