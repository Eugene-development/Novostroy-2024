...
export const metadata = {
  ...
  description: "Разрабатываем дизайн-проекты интерьеров с учётом эргономики, подбора материалов и цветовой палитры. Индивидуальный подход для создания стильного и функционального пространства.",
};
