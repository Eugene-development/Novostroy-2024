...
export const metadata = {
  ...
  description: "Получите профессиональную консультацию дизайнера интерьера: выезд на объект, консультации по телефону, в мессенджере или в нашем салоне. Подберём лучшие решения для вашего интерьера.",
};
