...
const reviews = [
  ...
  {
    title: "Закажем ещё",
    body: "Купили у вас гардероб. Каждая деталь продумана. Мы остались довольны своей покупкой.",
    author: "Сергей",
    rating: 5,
  },
  {
  ...
  {
    title: "Мы рады!",
    body: "Скорее всего, у нас самый крутой кухонный гарнитур среди друзей. Не можем налюбоваться! Спасибо за работу.",
    author: "Танечка",
    rating: 5,
  },
  {
    title: "Не подвели.",
    body: "Знаком с вами очень давно. Порадовал адекватный выбор материалов для нашей спальни.",
  ...
  },
  {
    ...
    body: "Мы довольны результатом выполненных работ. Наш новый шкаф в прихожую - это просто #красота!",
    author: "Лена",
    rating: 5,
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              работе. Мы будем очень стараться для этого.
            </p>
          </div>
        </div>
