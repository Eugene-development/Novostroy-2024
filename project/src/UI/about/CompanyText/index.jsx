      ...
      <div className="mx-auto max-w-5xl px-2 ">
        <div className="mx-auto lg:mx-0 ">
          <div className="mt-10 text-lg leading-8 text-gray-600 ">
            <div>
              <p>
                <span className="font-semibold">Наша команда</span> оказывает профессиональные дизайнерские услуги в сфере мебельной индустрии и создании интерьеров. За два десятилетия мы накопили богатый опыт, позволяющий нам
                создавать уникальные интерьеры, которые удовлетворяют самые
                разнообразные запросы клиентов.
              </p>
              <p className="mt-2">
                <span className="font-semibold">Мы предлагаем решения</span> для любых бюджетов, сохраняя
              ...
              <p className="mt-2">
                <span className="font-semibold">Наша экспертиза охватывает</span> различные стили — от классики до
              ...
              <p className="mt-2">
                <span className="font-semibold">Мы гордимся сотрудничеством</span> с ведущими производителями мебели,
              ...
              <p className="mt-2">
                <span className="font-semibold">Наша миссия — создать</span> для каждого клиента комфортное и стильное
                пространство, которое будет радовать многие годы. Мы внимательно
                слушаем ваши пожелания и воплощаем их в жизнь, предлагая
                оригинальные решения, которые не только украшают, но и делают
                жизнь удобнее.
              </p>

              <p className="mt-2">
                <span className="font-semibold">Обратившись к нам,</span> вы можете быть уверены в профессионализме и
                ответственности на каждом этапе работы — от идеи до ее
                реализации. Мы ценим доверие наших клиентов и всегда стремимся
                превзойти их ожидания, надеясь на положительную рекомендацию.
              </p>
            </div>
          </div>
