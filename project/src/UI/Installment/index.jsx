          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
            <div className="lg:pr-4 lg:pt-2">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Вы можете приобрести продукцию у наших партнеров на выгодных
                ...
                <figure className="mt-16 border-l border-gray-200 pl-8 text-gray-600">
                  <blockquote className="text-base leading-7">
                    <p>
                      “Подать заявку очень просто. Заполните анкету в любом
                      салоне наших партнеров и получите предварительное
                      одобрение от наших банков партнёров. Все расходы по
                      обслуживанию договора на себя возьмёт наша компания.”
                    </p>
                  </blockquote>
