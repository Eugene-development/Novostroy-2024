  ...
  return (
    <form action="#" method="get" className="px-3 pt-3">
      ...
      <div className="relative">
        ...
        <button
          type="submit"
          className="text-white absolute right-2.5 top-1/2 transform -translate-y-1/2 bg-gray-500 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 font-normal rounded-lg text-sm px-2 py-1.5 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800"
        >
          <svg
            aria-hidden="true"
