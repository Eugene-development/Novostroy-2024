      ...
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div className="mb-4 divide-y divide-gray-200 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:divide-gray-700 dark:border-gray-700 dark:bg-gray-800 md:p-6">
          <div className="items-center justify-between pb-4 md:flex">
            <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white md:mb-0">Electronics - Top Products <span className="ms-2 text-lg font-medium text-gray-500 dark:text-gray-400">298 products</span></h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div id="controls-carousel" className="relative w-full" data-carousel="static">
              ...
              <div className="relative mb-4 min-h-72 overflow-hidden rounded-lg">
                ...
                <div className="hidden duration-1000 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 2 --> */}
                <div className="hidden duration-1000 ease-in-out" data-carousel-item="active">
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-back.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-back-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 3 --> */}
                <div className="hidden duration-1000 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-components.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-components-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 4 --> */}
                <div className="hidden duration-1000 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-side.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-side-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
              </div>
          ...
          <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div id="controls-carousel" className="relative w-full" data-carousel="static">
              ...
              <div className="relative mb-4 h-72 overflow-hidden rounded-lg">
                ...
                <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 2 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-side.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-side-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 3 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-controller.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-controller-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 4 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
            ...
            <div>
              <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">PlayStation 5 Slim Console</a>
              <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">Up to 120fps with 120Hz output, 1TB HDD, 2 Controllers, Ray Tracing.</p>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center justify-end gap-2">
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-900 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Black" className="sr-only" checked />
                  <span id="color-choice-5-label" className="sr-only"> Black </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-900 border-opacity-10 bg-gray-900"></span>
                </label>
    
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-primary-700 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Blue" className="sr-only" />
                  <span id="color-choice-6-label" className="sr-only"> Blue </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-primary-700 border-opacity-10 bg-primary-700"></span>
                </label>
                ...
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-300 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Gray" className="sr-only" />
                  <span id="color-choice-7y-label" className="sr-only"> Gray </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-300 border-opacity-10 bg-gray-300"></span>
                </label>
              </div>
            </div>
          ...
          <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div id="controls-carousel" className="relative w-full" data-carousel="static">
              ...
              <div className="relative mb-4 h-72 overflow-hidden rounded-lg">
                {/* <!-- Item 1 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-side.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-side-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 2 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 3 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-keyboard.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-keyboard-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 4 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
            ...
            <div>
              <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">iPad Pro 13-Inch (M4): XDR Display</a>
              <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">Ultra Retina XDR Display, 256GB, Landscape 12MP Front Camera/12MP.</p>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center justify-end gap-2">
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-900 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Black" className="sr-only" checked />
                  <span id="color-choice-8-label" className="sr-only"> Black </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-900 border-opacity-10 bg-gray-900"></span>
                </label>
    
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-pink-600 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Blue" className="sr-only" />
                  <span id="color-choice-9-label" className="sr-only"> Blue </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-pink-600 border-opacity-10 bg-pink-600"></span>
                </label>
    
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-300 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Gray" className="sr-only" />
                  <span id="color-choice-10-label" className="sr-only"> Gray </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-300 border-opacity-10 bg-gray-300"></span>
                </label>
              </div>
            </div>
          ...
          <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div id="controls-carousel" className="relative w-full" data-carousel="static">
              ...
              <div className="relative mb-4 h-72 overflow-hidden rounded-lg">
                {/* <!-- Item 1 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-controller.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-controller-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 2 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 3 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-side.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-side-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 4 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
            ...
            <div>
              <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Xbox Series S 1TB SSD</a>
              <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">All-Digital Gaming Console 1440p Gaming 4K Streaming Carbon Black.</p>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center justify-end gap-2">
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-900 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Black" className="sr-only" checked />
                  <span id="color-choice-11-label" className="sr-only"> Black </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-900 border-opacity-10 bg-gray-900"></span>
                </label>
                ...
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-100 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Gray" className="sr-only" />
                  <span id="color-choice-12-label" className="sr-only"> Gray </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-100 border-opacity-10 bg-gray-100"></span>
                </label>
              </div>
            </div>
          ...
          <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div id="controls-carousel" className="relative w-full" data-carousel="static">
              ...
              <div className="relative mb-4 h-72 overflow-hidden rounded-lg">
                {/* <!-- Item 1 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 2 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-camera.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-camera-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 3 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/airpods.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/airpods-dark.svg" className="absolute left-1/2 top-1/2 hidden h-full -translate-x-1/2 -translate-y-1/2 dark:block" alt="..." />
                </div>
                {/* <!-- Item 4 --> */}
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-light.svg" className="absolute left-1/2 top-1/2 block h-full -translate-x-1/2 -translate-y-1/2 dark:hidden" alt="..." />
            ...
            <div>
              <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple iPhone 15 Pro Max</a>
              <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">256GB, Natural Titanium, 6.7 Inches - Unlocked (Renewed), Unlocked for All Carriers.</p>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <p className="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$1299</p>
    
              <div className="flex items-center justify-end gap-2">
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-900 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Black" className="sr-only" checked />
                  <span id="color-choice-0-label" className="sr-only"> Black </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-900 border-opacity-10 bg-gray-900"></span>
                </label>
                ...
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-purple-500 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Blue" className="sr-only" />
                  <span id="color-choice-0-label" className="sr-only"> Blue </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-purple-500 border-opacity-10 bg-purple-500"></span>
                </label>
    
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-300 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Gray" className="sr-only" />
                  <span id="color-choice-0-label" className="sr-only"> Gray </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-300 border-opacity-10 bg-gray-300"></span>
                </label>
              </div>
            </div>
          ...
          <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div>
              <a href="#" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">iMac 24" (2021)</a>
              <p className="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">Retina 4.5K, 8GB, 256GB SSD, 8-core GPU, Orange, INT KB.</p>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <p className="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$1999</p>
    
              <div className="flex items-center justify-end gap-2">
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-900 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Black" className="sr-only" checked />
                  <span id="color-choice-16-label" className="sr-only"> Black </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-gray-900 border-opacity-10 bg-gray-900"></span>
                </label>
                ...
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-sky-600 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Blue" className="sr-only" />
                  <span id="color-choice-17-label" className="sr-only"> Blue </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-sky-600 border-opacity-10 bg-sky-600"></span>
                </label>
                ...
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-orange-400 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Gray" className="sr-only" />
                  <span id="color-choice-18-label" className="sr-only"> Orange </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-orange-400 border-opacity-10 bg-orange-400"></span>
                </label>
                ...
                <label className="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-teal-400 focus:outline-none has-[:checked]:ring-2">
                  <input type="radio" name="color-choice" value="Blue" className="sr-only" />
                  <span id="color-choice-17-label" className="sr-only"> Teal </span>
                  <span aria-hidden="true" className="h-7 w-7 rounded-full border border-teal-400 border-opacity-10 bg-teal-400"></span>
                </label>
              </div>
            </div>
