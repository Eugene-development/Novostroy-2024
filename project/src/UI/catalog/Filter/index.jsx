    ...
    <>
      <div className="items-center justify-between space-y-4 py-4 lg:flex lg:space-y-0">
        <div className="grid grid-cols-2 items-center gap-4 md:flex ">
          ...
          <div
            id="dropdownBrands"
            className="z-50 hidden w-48 divide-y divide-gray-100 rounded-lg bg-white shadow dark:divide-gray-600 dark:bg-gray-700"
          ...
          >
            <ul className="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
              <li className="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                <input
                  ...
                  type="checkbox"
                  value=""
                  className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-sky-600 focus:ring-2 focus:ring-sky-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-800 dark:focus:ring-sky-600"
                />
                <label
                  for="brand-checkbox-1"
                  className="inline-flex w-full items-center gap-2 text-gray-900 dark:text-gray-300"
                >
                  Apple{" "}
                  <span className="ms-auto text-gray-500 dark:text-gray-400">
                    1,276
                  </span>
                </label>
              </li>
            ...
            <div className="p-2">
              <button
                type="button"
                className="w-full rounded-md bg-sky-700 px-3 py-2 text-sm font-medium text-white hover:bg-sky-800 focus:outline-none focus:ring-4 focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800"
              >
                See all 1,011 results
              </button>
            </div>
          </div>
          <button
          ...
          <div
            id="dropdownRating"
            className="z-50 hidden w-56 divide-y divide-gray-100 rounded-lg bg-white shadow dark:divide-gray-600 dark:bg-gray-700"
            data-popper-placement="bottom"
          >
            <ul className="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
              <li className="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                <input
                  id="rating-checkbox-6"
                  type="checkbox"
                  value=""
                  className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-sky-600 focus:ring-2 focus:ring-sky-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-sky-600"
                  checked
              ...
              <li className="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                <input
                  id="rating-checkbox-8"
                  type="checkbox"
                  value=""
                  className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-sky-600 focus:ring-2 focus:ring-sky-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-sky-600"
                />
                <label
                  for="rating-checkbox-8"
                  className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 dark:text-gray-400"
                >
                  <div className="flex items-center gap-0.5">
                    <svg
              ...
              <li className="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                <input
                  id="rating-checkbox-9"
                  type="checkbox"
                  value=""
                  className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-sky-600 focus:ring-2 focus:ring-sky-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-sky-600"
                />
                <label
                  for="rating-checkbox-9"
                  className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 dark:text-gray-400"
                >
                  <div className="flex items-center gap-0.5">
                    <svg
              ...
              <li className="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                <input
                  id="rating-checkbox-10"
                  type="checkbox"
                  value=""
                  className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-sky-600 focus:ring-2 focus:ring-sky-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-sky-600"
                />
                <label
                  for="rating-checkbox-10"
                  className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 dark:text-gray-400"
                >
                  <div className="flex items-center gap-0.5">
                    <svg
          ...
          <button
            id="shippingDropdownButton"
            data-dropdown-toggle="dropdownShipping"
            type="button"
            className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-sky-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto"
          >
            <svg
          ...
          <div
            id="dropdownShipping"
            className="z-50 hidden w-72 divide-y divide-gray-100 rounded-lg bg-white shadow dark:divide-gray-600 dark:bg-gray-700"
            data-popper-placement="bottom"
          >
            <div className="space-y-3 p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
              <label for="asia-1" className="relative block">
                <input
                  ...
                  name="asia-1"
                  id="asia-1"
                  className="peer absolute left-2 top-2 appearance-none"
                />
                <div className="relative cursor-pointer space-y-1 overflow-hidden rounded-lg border border-gray-200 bg-white p-4 text-gray-500 peer-checked:border-sky-700 peer-checked:bg-sky-50 peer-checked:text-sky-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:peer-checked:border-sky-600 dark:peer-checked:bg-sky-900 dark:peer-checked:text-sky-300">
                  ...
                  <p className="text-sm font-normal">
                    ...
                    <span className="font-medium">$954</span>
                  </p>
                </div>
              </label>
              ...
              <label for="africa-1" className="relative block">
                ...
                <div className="relative cursor-pointer space-y-1 overflow-hidden rounded-lg border border-gray-200 bg-white p-4 text-gray-500 peer-checked:border-sky-700 peer-checked:bg-sky-50 peer-checked:text-sky-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:peer-checked:border-sky-600 dark:peer-checked:bg-sky-900 dark:peer-checked:text-sky-300">
                  ...
                  <p className="text-sm font-normal">
                    ...
                    <span className="font-medium">$706,834</span>
                  </p>
                </div>
              </label>
              ...
              <label for="americas-1" className="relative block">
                ...
                <div className="relative cursor-pointer space-y-1 overflow-hidden rounded-lg border border-gray-200 bg-white p-4 text-gray-500 peer-checked:border-sky-700 peer-checked:bg-sky-50 peer-checked:text-sky-700 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400 dark:peer-checked:border-sky-600 dark:peer-checked:bg-sky-900 dark:peer-checked:text-sky-300">
                  ...
                  <p className="text-sm font-normal">
                    ...
                    <span className="font-medium">$365,35</span>
                  </p>
                </div>
              </label>
              ...
              <label for="australia-1" className="relative block">
                ...
                <div className="relative cursor-pointer space-y-1 overflow-hidden rounded-lg border border-gray-200 bg-white p-4 text-gray-500 peer-checked:border-sky-700 peer-checked:bg-sky-50 peer-checked:text-sky-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:peer-checked:border-sky-600 dark:peer-checked:bg-sky-900 dark:peer-checked:text-sky-300">
                  ...
                  <p className="text-sm font-normal">
                    ...
                    <span className="font-medium">$209,98</span>
                  </p>
                </div>
              </label>
              ...
              <label for="europe-1" className="relative block">
                ...
                <div className="relative cursor-pointer space-y-1 overflow-hidden rounded-lg border border-gray-200 bg-white p-4 text-gray-500 peer-checked:border-sky-700 peer-checked:bg-sky-50 peer-checked:text-sky-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:peer-checked:border-sky-600 dark:peer-checked:bg-sky-900 dark:peer-checked:text-sky-300">
                  ...
                  <p className="text-sm font-normal">
                    ...
                    <span className="font-medium">$1,365,35</span>
                  </p>
                </div>
              </label>
        ...
        <div className="shrink-0 items-center gap-4 sm:flex">
          <p className="mb-2 text-base font-medium text-gray-900 dark:text-white sm:mb-0">
            Seller:
          </p>
