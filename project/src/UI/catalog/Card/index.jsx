        ...
        {dataCategory?.product.map((item) => (
          ...
          >
            ...
            <div className="mt-4 md:mt-6 sm:flex sm:items-center lg:flex-col max-w-sm">
              ...
              <Link
                href={`/${dataCategory.parentable.parentable.slug}/${item.slug}`}
                className="inline-flex mt-4 w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-sky-600 via-sky-700 to-sky-600 hover:from-sky-600 hover:to-sky-500 px-5 py-2.5 text-sm font-medium text-white  focus:outline-none focus:ring-4 focus:ring-sky-300"
              >
                Подробнее
              </Link>
            </div>
