...
const features = [
  ...
  {
    name: "Подарок от компании.",
    description:
      "Осуществим сборку нашими квалифицированными специалистами и оплатим их работу.",
    icon: Cog6ToothIcon,
  },
  {
    name: "Скидки от фабрики.",
    description:
      "Постоянные дополнительные скидки от фабрики на различные позиции мебели.",
    icon: ArrowPathIcon,
  },
  {
    name: "Особое предложение.",
    description:
      "Если вы приобретаете мебель повторно, то для вас будет особое предложение.",
    icon: FingerPrintIcon,
  },
  {
    name: "Такси до дома.",
    description:
      "После оформления договора вызовем вам такси в пределах МКАД за счет компании.",
    icon: Cog6ToothIcon,
  },
];
debugger;
