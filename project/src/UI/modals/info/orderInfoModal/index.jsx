...
export default () => {
  ...
  const { currentVisibleOrderInfo, closeVisibleOrderInfo } = useOrderInfoStore.visibleOrderInfo();
  ...
  return (
    <Dialog open={currentVisibleOrderInfo} onClose={closeVisibleOrderInfo} className="relative z-10">
      <DialogBackdrop
        transition
              ...
              <div className="relative p-4 w-full max-w-6xl h-full md:h-auto">
                  <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                          <div className="flex justify-between mb-4 rounded-t sm:mb-5">
                              ...
                              <div>
                                  <button onClick={() => closeVisibleOrderInfo()} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="readProductModal">
                          ...
                          <dl className="sm:mb-10">
                              <dt className="mb-2 font-semibold leading-none text-gray-900 dark:text-white">От знакомства до покупки</dt>
                              <dd className="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">На первый взгляд этот путь достаточно сложный и рискованный. Наша команда поможет пройти все этапы от А до Я максимально комфортно. Мы будем сопровождать вас на всём пути и по итогу поздравим Вас с замечательным приобретением!</dd>
                          ...
                          <div className="flex pt-4 justify-between items-center">
                              <div className="flex items-center space-x-3 sm:space-x-4">
                                  <button onClick={()=> openVisibleFormDesigner()} type="button" className="text-white inline-flex items-center bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">
                                  ...
                                  <button onClick={() => openVisibleFormMeasuring()} type="button" className="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-sky-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                      Замер помещения
                                  </button>
                              </div>              
                              <button onClick={() => closeVisibleOrderInfo()} type="button" className="inline-flex items-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
